...
#include "mcmlfModule.h"

static PyObject *_mcmlf(PyObject* self, PyObject* args)
{
  int error = 0;
...
static PyMethodDef mcmlfMethods[] =
{
  {"mcmlf", _mcmlf, METH_VARARGS, "Monte Carlo Multi-Layer for focusing beams"},
  {NULL, NULL, 0, NULL}
};

#ifdef IS_PY3K
static struct PyModuleDef mcmlfmodule = {
  PyModuleDef_HEAD_INIT,
  "mcmlfModule",   /* name of module */
...
PyMODINIT_FUNC PyInit_mcmlfModule(void)
{
  return PyModule_Create(&mcmlfmodule);
}
#else
PyMODINIT_FUNC initmcmlfModule(void)
{
    (void) Py_InitModule3("mcmlfModule", mcmlfMethods, "Monte Carlo Multi-Layer for focusing beams");
}
#endif
